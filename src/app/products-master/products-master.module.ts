...
import { ProductsMasterRoutingModule } from './products-master-routing.module';
...
@NgModule({
  declarations: [
    ProductsMasterListComponent,
    ProductsMasterBreadComponent
  ],
  imports: [
    CommonModule,
    ProductsMasterRoutingModule,
    FormsModule,
